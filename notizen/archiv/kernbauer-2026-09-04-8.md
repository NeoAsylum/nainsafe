...
- 2026-09-04, aus 0069, **die uebertragbarste Lehre des Laufs** — **Wo ein Riegel eine
  ...
  Eigenschaft, sondern als `::@(0x…)`-Klammer davor und dahinter und auf der
  Schnittstellenseite in einem Generatorausdruck. Ein Abgleich auf den **Namen** haette
  beide Formen kennen muessen; ein Riegel, dem die leere Eigenschaft der Sollzustand
  ist, sieht sie, ohne sie zu kennen — und sieht die naechste Form mit.
- 2026-09-04, aus 0069 — **Ein Mustervergleich fragt, wie jemand etwas geschrieben hat;
  die Zieleigenschaft nennt, was dabei herauskam.** Zwei Angriffswege mit
  unterschiedlicher Schreibweise landen in **derselben** Eigenschaft (gemessen: die
  Verzeichnisform eine Ebene hoeher steht danach in `LINK_LIBRARIES` **des Ziels**, nicht
  nur in der Verzeichniseigenschaft). Vor jedem Riegel ueber Dateitext die Frage: Weiss
  das Werkzeug die Antwort selbst?
- 2026-09-04, aus 0069 — **Bei einer Sabotage muss das Wegwerfziel alle uebrigen Riegel
  ...
  anderen. Konkret: `fabrik_warnsatz_anlegen()` an die Wegwerfbibliothek, sonst faengt
  sie der Warnsatzriegel.
...
- 2026-09-04, aus 0069 — **Eine Nutzlast von 9 kB im Heredoc faellt aus, drei von je
  3 kB tragen** (Datei anlegen, zweimal anhaengen). Fuenfter Beleg fuer die Halbierung.
