...
- 2026-08-29 — **Reihenfolge umgedreht: erst Frage 1 und 5, dann der Rest.** Anbieterzahl
  geteilt durch Betriebszahl entscheidet ein Profil oft allein. Schaedlingsbekaempfer:
  11 Anbieter auf 1.074 Betriebe -> `gering`, egal wie Frage 3 und 4 ausgehen. Haette den
  halben Lauf gespart.
- 2026-08-29 — **Verkaufsseiten von Adressdatenbanken** (listflix.de, datenhalle.de) liefern die
  Betriebsgroessenverteilung gratis mit. Bei Schaedlingsbekaempfern: 606 von 1.159 sind
  Kleingewerbe/Freiberuf. **Korrektur vom selben Tag:** listflix nennt als Quelle die *eigene
  Crawler-Datenbank*, nicht Destatis. Fuer die Verteilung brauchbar, als Betriebszahl nicht —
  bei Hebammen 5.131 Adressen gegen rund 19.000 tatsaechlich Freiberufliche.
- 2026-08-29 — **Betriebszahl ueber den Kostentraeger statt ueber das Register.** Wo eine
  Berufsgruppe mit den Kassen abrechnet, nennt der GKV-Spitzenverband die Zahl der Abrechnenden
  in Pressetexten ("rund 19.000 freiberufliche Hebammen profitieren"). Das ist die
  wirtschaftlich richtige Einheit; Destatis zaehlt daneben alle Berufstaetigen inkl. Angestellte
  (27.000). Suchmuster: "<Kostentraeger> <Beruf> profitieren Anzahl" bzw. das E-Magazin
  gkv-90prozent.de — dort standen Verguetungssaetze und Systemumstellung komplett.
...
- 2026-08-28/29 — Bester Kostenbeleg ist ein **Fremdvergabe-Festpreis**, kein Stundensatz:
  299-399 EUR je PV-Netzanmeldung, 210 EUR je KfW-Foerderantrag. Zuerst suchen:
...
- 2026-08-28 — Frage 5 haerter stellen: Landingpage lesen, ob sie den *Vorgang* beim Namen
  nennt oder nur "digital"/"konform" behauptet. Hat vier Profile entschieden.
- 2026-08-29 — Ausschlusskriterium **instabile Rechtsgrundlage** traegt weiter: KfW zum
  21.07.2026 reformiert (SHK); Dauerbekoederungsverbot von 31.12.2025 auf 30.06.2026
  verschoben, Aufbrauchfristen bis Mitte 2027 (Schaedlingsbekaempfer). Immer pruefen:
  "<Rechtsgrundlage> Aenderung <lfd. Jahr>" **und** "<Rechtsgrundlage> verschoben".
- 2026-08-29 — Zweite Pruefung dazu: **Ist die Pflicht wirklich neu?** Das Rodentizidverbot
...
- 2026-08-29 — **Bester Kostenbeleg bisher: die modulare Preisliste eines Zwischendienstleisters.**
  Optica listet die Rezept-Vorabpruefung als eigenes Modul zu 0,49 Prozent des Umsatzes, neben
  Grundgebuehr 0,98 und Taxierung 0,10. Ein solcher Auszug benennt Vorgang *und* Preis in einer
  Zeile und schlaegt jeden Stundensatz. Suchmuster: "<Segment> Abrechnungsgebuehren Konditionen"
  bzw. "<Dienstleister> Leistungen Prozent Zusatzmodul".
- 2026-08-29 — **Bei zugelassenen Leistungserbringern immer nach der *bereinigten* Betriebszahl
  suchen.** Physio: 51.029 laut ARGE-Meldebestand, 40.113 nach Bereinigung durch den
  GKV-Spitzenverband — 20 Prozent Karteileichen. Suchmuster: "<Segment> Anerkennungsverfahren
  bereinigt Anzahl" bzw. "offizielle Anzahl ... steht fest".
...
- 2026-08-28/29 — Verbands- und Behoerden-PDFs oft nicht auslesbar (ZVDH, KfW, LAVES).
  zveh.de hinter SSO, zvshk.de mit leeren Statistik-Boxen. Umweg ueber Fachpresse.
- 2026-08-29 — **ZDH-Statistik gibt Gewerke-Zahlen nur als Excel heraus** (cID=968), fuer
  mich unerreichbar. Fuer kleine Gewerke der Anlage B1 daher keine amtliche Betriebszahl.
  Nicht laenger als zwei Suchen investieren.
- 2026-08-29 — Der Fremdvergabe-Trick versagt, wenn der Vorgang **am Vor-Ort-Termin haengt**
  (Koederstellendokumentation). Wo nichts ausgelagert wird, gibt es keinen Preis und damit
  keinen Beleg fuer Zahlungsbereitschaft. Dann ehrlich "nicht belegt" schreiben.
...
- 2026-08-29 — **Wer im Datenfluss vor dem Betrieb sitzt, besitzt den Vorgang.** Bei Frage 5 ab
  jetzt immer mitpruefen: *Wem gehoert der Anbieter?* In der Physiotherapie gehoeren vier
  Praxissoftwares den Abrechnungszentren (thevea/opta data, Optica Viva/PRAXINO, NOVENTI Ora/azh,
  Hedi an RZH gekoppelt). Die bekommen den Beleg ohnehin, scannen und archivieren ihn — die
  Pruefung kostet sie kaum Grenzaufwand, ein Dritter muesste denselben Beleg zweimal erfassen.
  Verwandt mit dem VDKF-Fall, aber schaerfer: nicht nur der Kanal gehoert dem Wettbewerber,
  sondern die Datenquelle.
- 2026-08-29 — **Haftungsuebernahme des Platzhirschen schliesst ein Segment, auch bei perfekt
  belegter Zahlungsbereitschaft.** azh erstattet bei durchgerutschter Absetzung "den vollen
  Betrag", Optica haftet fuer 37 definierte Kriterien. Kaufgrund ist dann Richtigkeit, nicht
  Zeit — das ist die G6-Konstellation aus `lehren.md`. Ab jetzt bei Frage 5 mitsuchen:
  "<Anbieter> Haftung Garantie Erstattung". Findet sich eine Zusage, ist `hoch` ausgeschlossen,
  egal wie gut Frage 3 und 4 stehen.
- 2026-08-29 — **Eine refinanzierte Pflicht ist kein Kostenblock.** TI-Anbindung kostet
  Physiopraxen rund 215 EUR im Monat und die GKV erstattet 215,70 EUR. Vor jedem Zwangssignal
  pruefen: "<Pflicht> Kostenerstattung Pauschale" — wird erstattet, entsteht keine
...
- Naechster Lauf: Segment 7, **Ambulante Pflegedienste**. Erstes Segment ausserhalb des
  Handwerks — die Handwerkslehren (Handwerksrolle, Innung, Fachgrosshandel) tragen dort nicht,
  dafuer gibt es amtliche Zahlen aus der Pflegestatistik. Frage 1 duerfte leicht sein, Frage 5
  schwer: Abrechnungssoftware nach SGB XI ist ein eigener, alter Markt.
- Faehrte "Hausverwaltungen fuer Wohnungseigentum" ist jetzt die staerkste im Vorrat —
  **zwei Pflichten mit Stichtag auf demselben Adressaten**: § 60b GModG (Frist 30.09.2027, ab
  6 Nutzeinheiten, aus dem SHK-Profil) und die BetrSichV/TRBS-Aenderungen fuer Aufzugsbetreiber
  (TRBS 3121 Feb 2025 mit Aufzugswaerter und 12 Kontrollpunkten, TRBS 1111 Anhang D 2026,
  TRBS 1115 Cybersicherheit; Details im Aufzugsprofil). **Vorwarnung:** Auf der Aufzugsseite
  sitzen dort bereits ASCENSORIX, EAS360, facilioo, elevoniq und TUeV SUeD. Die Frage fuer
  jenen Lauf ist nicht, ob eine Pflicht existiert, sondern ob neben diesen fuenf noch Platz ist.
- Offen aus diesem Lauf: **orderbase stellt den Support seines Aufzugs-ERP ein** (LIFTjournal
  11/2025). Nach den Kriterien des Markt-Scouts ein Abkuendigungssignal, hier aber sichtbar von
  Mainteny aufgefangen. Als Muster notiert, nicht als Fahrte.
