...
- BFSG-Kleinstunternehmen-Ausnahme (§ 3 Abs. 3 BFSG) ist laut Gesetzeswortlaut
  **unbefristet** -- ein Blog (mk-websolution.de) behauptete faelschlich, sie
  ...
  diesem Anbieter kuenftig.
- EU-Kleinunternehmerregelung (KU-IdNr., vierteljaehrliche Umsatzmeldung ans
  BZSt) ist seit 2025 in Kraft, aber **freiwillig** (nur bei grenzueberschreitender
  Nutzung der Regelung) -- kein Zwang, daher kein Signal nach jetzigem Massstab.

## Lauf 2026-08-29 (3.)

- Alle 18 bisherigen Dateien plus Beobachtungsliste durchgegangen: Nichts Neues.
  Mehrere Kandidaten (KRITIS-Frist, NIS2, KI-Kennzeichnung Art. 50,
