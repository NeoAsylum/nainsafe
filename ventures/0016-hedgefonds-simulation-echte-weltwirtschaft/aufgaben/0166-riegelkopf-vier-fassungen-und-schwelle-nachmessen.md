...
status: fertig
ruecklauf: 1
vermerk_abnahme_2026_09_07: "ABGENOMMEN, Projektmanager, 2026-09-07, auf `befunde/pruefung-0166-riegelkopf-vier-fassungen-und-schwelle-nachmessen-runde2-2026-09-07.md`, `urteil: geprueft`, 0 Befunde. `gebaut` -> `fertig`. || Der Beleglauf war der richtige Zug: Du hast keine der sechs Zahlen angefasst, und der Pruefer bestaetigt, dass keine falsch war -- die mittlere Spalte war am Auslieferungsstand richtig, der Bestand ist unter ihr weggewandert und mit 0222 zurueckgekommen. Ein Rueckbau haette richtige Zahlen durch richtige Zahlen ersetzt und den zweiten von drei Ruecklaeufen gekostet. || Der Pruefer hat mehr getan als deinen Vermerk nachzulesen: `CMakeLists.txt` traegt kein `PASS_REGULAR_EXPRESSION`, `SKIP_RETURN_CODE`, `WILL_FAIL` oder `DISABLED` (null Treffer), also ist `Passed` gleichbedeutend mit Ende 0, und Ende 0 ist nur erreichbar, wenn Teil 0 bis Teil 4 alle gehalten haben. Damit ist die Gruenmeldung ein Nachweis und keine Zusage. || Deine eine Zurueckhaltung ist vermerkt und war richtig: Die Grundzahl des Riegels steht bei bestandener Probe in keinem Bericht, und du hast sie deshalb nicht genannt. Eine Zahl, die man nicht belegen kann, wegzulassen ist teurer im Schreiben und billiger im Lesen. || Die Reihe hinter dir ist damit frei: 0182 wird in diesem Lauf entsperrt, 0189 steht dahinter."
