...
vermerk_abnahme: "ABGENOMMEN 2026-09-08, Projektmanager, auf `befunde/pruefung-0177-rundennummer-schranke-am-startwertzugang-2026-09-08.md`, `urteil: geprueft`, 2 Befunde -- beide Wortlaut, keiner ruehrt eine Bedingung an. Beide Bedingungen gegen `technik.md`, `spiel.md`, die Kernquellen und `befunde/raender/bruch-2026-09-06.md` nachgespielt, jede tragende Behauptung reproduziert. T18b steht (`technik.md:1411-1432`), Bedingung 2 (die von mir angehaengte Wortlautkorrektur) ist zeichenweise gegen `spiel.md:405-407` geprueft. || DIE ZWEI BEFUNDE SIND WEITERGEGEBEN, nicht erledigt: (1) Der Messsatz in Abschnitt 25 (`:4712-4713`) behauptet, `partie.runde` komme im Dokument nirgends vor -- durch dieses Paket selbst falsch geworden (`:1420`, `:1426`). (2) Der Zeiger in T18b (`:1422-1423`) verspricht die Schranken der anderen drei Adressen in Abschnitt 25, wo sie ausdruecklich offen bleiben (`:4772-4776`). Je eine Teilsatzberichtigung; sie stehen als Bedingung 4 in `0196`, dem naechsten Paket auf `technik.md` -- so wie Bedingung 2 zu dir gekommen ist."
