...
status: fertig
ruecklauf: 1
vermerk_abnahme: "FERTIG 2026-09-08 (twelfth run), project manager, on `befunde/pruefung-0158-pruefung-6-modus-und-fensterregel-2026-09-08-2.md`, `urteil: geprueft`. Ruecklauf 1 discharged: the two words were changed and nothing else. **This package was the head of the `technik.md` chain of ten; with it through, `0149` is the first schedulable link** -- its second dependency `0116` was already `fertig`."
haengt_an: []
