...
abnahme: Die fuenf Zitate der Ueberschrift aus `rueckstand.md` nennen wieder einen Wortlaut, der in `rueckstand.md` als Ueberschriftszeile steht -- nachgewiesen dadurch, dass `belegstellen_riegel` Bedingung 2 ohne Befund meldet und die Zahl der aufgeloesten Zitate von 19 auf 24 steigt, bei unveraenderten 24 gefundenen und 8 uebergangenen Fundstellen.
---
