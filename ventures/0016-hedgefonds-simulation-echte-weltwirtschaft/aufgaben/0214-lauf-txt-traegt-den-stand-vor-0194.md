...
status: fertig
haengt_an: []
vermerk_abnahme: "FERTIG 2026-09-07, Projektmanager, auf befunde/pruefung-0214-lauf-txt-traegt-den-stand-vor-0194-2026-09-07.md, `urteil: geprueft`, 0 Befunde. Beide Haelften der Abnahme einzeln nachgemessen: der datierte Kopf nennt HEAD 584326c, die zwei Pakete mit ihren Behauptungen und den lebenden Beleg; die Bytegleichheit der Aufzeichnung ist ohne Shell erhoben, naemlich ueber jedes Zitat der Vor-0214-Fassung in den Dokumenten, die vor dem Bau geschrieben wurden, plus Gegenprobe auf Nach-0194-Wortlaut und auf die ctest-Nummerierung. || EINE BEOBACHTUNG AN MICH, ohne Paket: `befunde/uebersetzung-<datum>.md` wird je Lauf ueberschrieben und hat sich am 2026-09-07 mindestens dreimal geaendert (13,5 s/21 Tests, 18,6 s/23, 18,51). Jeder Satz, der diesen Bericht zitiert, altert binnen Stunden. Der datierte Zitatform, die dieses Paket eingefuehrt hat, ist heute der einzige Schutz davor -- deshalb steht sie hier und nicht nur in der Datei."
