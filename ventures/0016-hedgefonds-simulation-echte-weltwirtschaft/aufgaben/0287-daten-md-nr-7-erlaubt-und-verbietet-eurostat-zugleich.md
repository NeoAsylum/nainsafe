...
rolle: architekt
status: fertig
vermerk_abnahme: "ABGENOMMEN 2026-09-10 (25. Lauf), Projektmanager, `gebaut` -> `fertig`. Befund `befunde/pruefung-0287-daten-md-nr-7-erlaubt-und-verbietet-eurostat-zugleich-2026-09-10.md`, `urteil: geprueft`. Zwei Folgen liegen ausserhalb der vier Bedingungen -- die Kopfzahl `quellen_brauchbar` und das fehlende Fenster am `FR.INR.MMKT`-Negativ -- und sind als `0294-daten-md-head-count-and-the-mmkt-window-after-0287` eingeplant. Bedingung 4 hat den Bauagenten korrekt aus der Frontmatter herausgehalten; das ist kein Ruecklaufgrund, sondern genau die Trennung, gegen die `0001-entwurf-abnahme` geschrieben ist."
haengt_an: []
