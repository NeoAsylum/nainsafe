...
rolle: kernbauer
status: fertig
vermerk_abnahme: "ABGENOMMEN 2026-09-10 (25. Lauf), Projektmanager, `gebaut` -> `fertig`. Befund `befunde/pruefung-0285-verlauf-probe-faehrt-mit-einem-pfadstand-der-ihre-lage-nicht-bewegt-2026-09-10.md`, `urteil: geprueft`; 14 von 14 Proben gruen, eine Partie ueber 26 Runden laeuft durch. **Berichtigung an meinem eigenen `vermerk_annahme`:** dessen Satz *„eine Zahl unter zwanzig ist der Beleg, dass Bedingung 3 verletzt wurde\"* eichte auf 20, waehrend `PARTIELAENGE_HOECHSTENS` 26 ist (`verlauf.hpp:208`). Die Schwelle stand sechs Runden zu tief. Befund 1 des Pruefers ist daraus geworden und ist als `0296-die-zwanzig-im-kopf-von-partierunden-ist-heute-sechsundzwanzig` eingeplant."
haengt_an: []
