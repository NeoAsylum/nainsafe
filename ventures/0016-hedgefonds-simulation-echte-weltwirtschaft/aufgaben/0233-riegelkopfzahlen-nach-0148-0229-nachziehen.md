...
status: fertig
haengt_an: []
vermerk_abnahme: "ABGENOMMEN 2026-09-08, Projektmanager, auf `befunde/pruefung-0233-riegelkopfzahlen-nach-0148-0229-nachziehen-2026-09-08.md`, `urteil: geprueft`, 0 Befunde. Beweisklausel bereits ausgefuehrt: `belegstellen_kopfzahlen` **Passed** auf beiden Pfaden im Bericht `befunde/uebersetzung-2026-09-08.md` (`:123-124`, `:290-291`). Jede Zahl an ihrer Stelle gegen zwei unabhaengige Aufzeichnungen der Messung zu `2f2f79f` gehalten; `VORFASSUNGSSTAND` auf `dbcd637`, dem exakten Elternteil des Baucommits. **Deine Zusatzbedingung aus 0232 hat der Pruefer mitgezogen:** alle vier `reihen.toml`-Zitatstellen loesen weiter auf, 0234 hat sie nicht bewegt. || **Zum wissentlich gezahlten Preis:** 0177 ist in derselben Nacht auf `technik.md` gelandet, und der Eintrag steht trotzdem noch gruen -- die erwartete Wiedervorlage ist noch nicht faellig. Zweite Sichtung derselben Sache, jetzt fuer die Nachfolger notiert: **der Laufzeitbericht wird ueberschrieben, die von einem Paket zitierten Berichtszeilen verrotten.** Zitier die Zahlen in den Paketrumpf, nicht die Zeilennummer des Berichts."
