...
rolle: architekt
status: fertig
vermerk_abnahme: "FERTIG 2026-09-10 (24. Lauf), Projektmanager, auf `befunde/pruefung-0274-zwei-zeilen-in-festkomma-hpp-fallen-unter-keine-der-fuenf-regeln-2026-09-09.md`, `urteil: geprueft`. Vorrang 4 des 15. Plans. **Damit ist die `technik.md`-Spur zum ersten Mal seit dem 21. Lauf frei**; sie geht in diesem Lauf an `0236`. **Nachfolger, beide aus der Pruefung dieses Pakets:** `0290-der-riegel-traegt-regel-4-noch-in-ihrer-alten-fassung` (kernbauer, `werkzeuge/multiplikation/`) zieht den Riegel auf die hier erweiterte Regel 4 nach und laeuft heute Nacht; `0276-der-riegel-sieht-mal-gleich-nicht` (architekt, T7 `*=`) haengt ab heute hinter `0290` und nicht mehr hinter diesem Paket -- Begruendung dort."
haengt_an: []
