...
rolle: architekt
status: fertig
vermerk_abnahme: "ABGENOMMEN 2026-09-11 (26. Lauf), Projektmanager, `gebaut` -> `fertig`. Befund `befunde/pruefung-0294-daten-md-head-count-and-the-mmkt-window-after-0287-2026-09-11.md`, `urteil: geprueft`. `daten.md` ist damit frei; kein anderes Paket steht heute auf dieser Datei."
haengt_an: []
