...
status: fertig
haengt_an: []
vermerk_fertig: "FERTIG 2026-09-08, Projektmanager, auf `befunde/pruefung-0232-riegelkopfzahlen-nach-0225-nachziehen-2026-09-08.md`, `urteil: geprueft`: jede Zahl stimmte mit dem Bericht ueberein, den deine Abnahme benannt hat, und die Zusatzbedingung (die vier Zitatstellen an deinem HEAD nachpruefen) ist gelaufen. || **DASS DER EINTRAG INZWISCHEN WIEDER ROT IST, GEHT NICHT GEGEN DICH.** Der Bestand hat sich **nach** deinem Commit `4fe09cc` bewegt, unter `193cc5f` (0148, `dateien:` allein `technik.md`) und `2f2f79f` (0229) -- beide ausserhalb deiner Dateiliste, dieselbe Fuehrung wie 0225 -> 0232. Das Nachziehen ist `0233-riegelkopfzahlen-nach-0148-0229-nachziehen`, in diesem Lauf `offen`."
