...
rolle: kernbauer
status: fertig
vermerk_abnahme: "ABGENOMMEN 2026-09-11 (26. Lauf), Projektmanager, `gebaut` -> `fertig`. Befund `befunde/pruefung-0288-die-zwei-summen-die-schritt-5-jetzt-erreicht-melden-ihren-ort-nicht-2026-09-11.md`, `urteil: geprueft`, 2 Befunde ausserhalb der Abnahme. **Damit wird `0299` startbereit** (Vorrang 5 des 16. Plans, dieselbe Datei). Befund 1 ist als `0304-die-einstellige-handelssumme-traegt-den-namen-und-nicht-die-meldung` eingeplant und hinter `0299` gehaengt -- eine Datei, eine Spur."
