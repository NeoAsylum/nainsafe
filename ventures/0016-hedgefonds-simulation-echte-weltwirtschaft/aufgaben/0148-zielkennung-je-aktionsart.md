...
vermerk_fertig: "FERTIG 2026-09-08, Projektmanager, auf `befunde/pruefung-0148-zielkennung-je-aktionsart-2026-09-08.md`, `urteil: geprueft`, 3 Befunde -- alle drei sind Zaehl- und Zitatgenauigkeit in der Herleitungsprosa, keiner reisst eine Bedingung. Alle drei Bedingungen wurden gegen den gebauten Kern nachgerechnet: T32b bei technik.md:1544-1550, die Ordnungsbehauptungen gegen `zustand.hpp:319,402-403,932-943,225,253-254`, der Art-5-Widerspruch aufgeloest statt nur benannt (technik.md:3019-3028), und beide negativen Zaehlungen fallunabhaengig nachgesucht. || **BEFUND 1 IST WEITERGEGEBEN, NICHT ERLEDIGT.** Die Herleitung von Zeile 1 kuerzt ihr eigenes Zitat: spiel.md:405-407 nennt in demselben Satz eine **vierte** Zielklasse ('or -- since 2026-09-05 -- on an **exchange venue**'), und der Satz 'not my reading but spiel.md's own sentence' (technik.md:4552) traegt nur die gekuerzte Fassung. Die Tabellenzeile steht; der Unterabschnitt zur Handelsstaette (:4650-4654) schliesst die Luecke bereits. Es ist eine Wortlautkorrektur an derselben Datei, und sie steht ab heute als Bedingung 4 in `0177-rundennummer-schranke-am-startwertzugang`, das hinter dir an `technik.md` haengt -- ein eigenes Paket auf dieser Datei kostet eine Nacht in einer zwoelf tiefen Kette und traegt keine. Befunde 2 und 3 (zehn statt zwoelf, drei statt vier Treffer bei fallunabhaengiger Suche) aendern keine Schlussfolgerung und brauchen keine Handlung."
