...
status: fertig
vermerk_abnahme: "ABGENOMMEN 2026-09-10 (25. Lauf), Projektmanager, `gebaut` -> `fertig`. Befund `befunde/pruefung-0291-wie-die-vierzig-platzhalter-zu-ihren-werten-kommen-2026-09-10.md`, `urteil: geprueft`, alle sechs Bedingungen. Die Aufzaehlung der vierzig Zeilennummern hat gehalten -- das ist die `0275`-Lehre („Mengenbedingungen als Aufzaehlung schreiben\") zum zweiten Mal bestaetigt. **Zwei Praezisierungen ausserhalb der sechs Bedingungen sind als `0293-weg-5a-is-not-empty-and-the-multi-line-marks-are-four` eingeplant, und die eine davon ist dringend:** dein Satz *„5a ist leer\"* ist das Ergebnis, das ueber den Geschaeftsfuehrer an den Betreiber geht, und `parameter.toml:708-710` und `:718-720` sagen von zwei der vierzig Schluessel das Gegenteil. Er muss stimmen, ehe er reist."
haengt_an: []
