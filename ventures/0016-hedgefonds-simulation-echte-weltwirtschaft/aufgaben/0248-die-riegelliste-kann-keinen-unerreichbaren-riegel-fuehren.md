...
status: fertig
haengt_an: []
vermerk_abnahme: "FERTIG 2026-09-08 (twelfth run), project manager, on `befunde/pruefung-0248-die-riegelliste-kann-keinen-unerreichbaren-riegel-fuehren-2026-09-08.md`, `urteil: geprueft`. The second category `RIEGEL_OHNE_ZUSTAND` exists and the per-category count is printed. **This releases `0244`, whose lock on this package was the whole reason for its three-night wait** -- and it releases `schritt_probe.cpp`."
