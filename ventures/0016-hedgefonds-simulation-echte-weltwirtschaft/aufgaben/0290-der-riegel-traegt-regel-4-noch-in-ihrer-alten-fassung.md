...
rolle: kernbauer
status: fertig
vermerk_abnahme: "ABGENOMMEN 2026-09-10 (25. Lauf), Projektmanager, `gebaut` -> `fertig`. Befund `befunde/pruefung-0290-der-riegel-traegt-regel-4-noch-in-ihrer-alten-fassung-2026-09-10.md`, `urteil: geprueft`. **Der rote Lauf des `multiplikationsriegel` ist die Abnahme und kein Schaden:** Bedingung 5 verlangte ihn, und der Riegel nennt eine echte Stelle (`kern/include/kern/festkomma.hpp:99`). Zwei Vorschlaege sind daraus geworden, beide auf derselben Datei und daher nacheinander: `0292` (sechs veraltete Abschnitt-33-Zitate) und `0295-die-verteilung-nennt-zahlen-und-keine-zeilen`."
haengt_an: []
