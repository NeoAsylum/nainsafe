...
(`/tmp/claude-1000/p0067`), am unveraenderten Quelltext des Pakets. Ich habe keine Datei
des Vorhabens angefasst.
...
* `daten/adressen.md` steht in der `dateien`-Liste von 0034 und in keiner zweiten.
...
Suche nach allen drei Schluesselwoertern ueber `daten/adressen.md` ergibt fuenf Treffer.
