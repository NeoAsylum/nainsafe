...
ablehnungsgrund: "G6 -- ein Agent handelt unbeaufsichtigt im Rechnungsausgang des Kunden, und der schlimmste Einzelfehler ist gross. Die alte Ablehnung traegt nach der Aenderung vom 2026-08-31 tatsaechlich nicht mehr: Eine Feldzuordnung aus einem Beispielexport herzuleiten und sie nachzufuehren, wenn das Altsystem sein Format aendert, ist Agentenarbeit und kostet keine Betreiberzeit -- G4 ist kein Treffer mehr. Genau dadurch faellt die Idee aber in den zweiten Weg zu G6, den dieselbe Aenderung eingefuehrt hat. Prueffrage aus G6: Was kostet der zehnte falsche Vorgang, bevor jemand ihn bemerkt? Eine falsch hergeleitete Zuordnung wirkt nicht auf eine Rechnung, sondern auf jede Rechnung desselben Laufs, weil die Zuordnung je Kunde gilt und nicht je Beleg; bei 200 Rechnungen im Monat ist der zehnte falsche Vorgang im selben Lauf erreicht. Ein falsch uebernommener Steuersatz erzeugt einen unrichtigen Steuerausweis, den der Aussteller nach Paragraph 14c UStG schuldet -- schon eine einzelne groessere Rechnung uebersteigt damit den Jahresumsatz mit diesem Kunden um Groessenordnungen. Der Ausweg ist seit dem 2026-08-31 ausdruecklich nicht mehr Aufsicht, denn Aufsicht waere wieder menschliche Zeit, sondern ein Produkt, dessen schlimmster Einzelfehler klein ist; ein Konverter im Rechnungsausgang ist das nicht. Verschaerfend der Kaufgrund: Der Kunde kauft die Aussage 'meine Rechnung ist konform', also Richtigkeit statt Zeitersparnis -- der Entwurf benennt das in seiner eigenen offenen Frage und verweist selbst auf 0001 und 0002. G3 wurde einzeln geprueft, wie die Wiedervorlage verlangt, und ist kein Treffer: Der Entwurf sagt keine Reaktionszeit zu, ein Rechnungslauf ist termin-, aber nicht stundenkritisch, und das Wertversprechen haengt an keinem anwesenden Menschen. Widerlegbar durch einen Zuschnitt, in dem der Kunde jede erzeugte Datei vor dem Versand freigibt und das Produkt nur den Unterschied zwischen Quelldatensatz und Ausgabe ausweist -- dann handelt kein Agent unbeaufsichtigt. Ob das noch verkaeuflich ist, ist offen; bei 200 Rechnungen im Monat ist gerade der ausbleibende Blick der Kaufgrund. Nicht geprueft, weil G6 vor G7 kommt: Die zentrale Vermutung des Entwurfs -- eine nennenswerte Zahl von Betrieben ueber 800.000 EUR Umsatz ohne angekuendigtes EN-16931-Update -- ist unerhoben, und die Besetzung des E-Rechnungsmarkts ist die erste offene Frage des Entwurfs selbst."
